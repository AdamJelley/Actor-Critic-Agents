...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau, n_actions, gamma=0.99, max_size=int(1e6), fc1_dims=400, fc2_dims=300, batch_size=64):
        self.gamma=gamma
        self.tau=tau
    ...
    def learn(self):
        ...
        new_critic_values = self.target_critic.forward(new_states, target_actions)
        critic_values = self.critic.forward(states, actions)

        new_critic_values[dones] = 0.0
        new_critic_values = new_critic_values.view(-1)
